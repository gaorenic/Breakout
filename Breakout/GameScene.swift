...
class GameScene: SKScene, SKPhysicsContactDelegate {
    ...
    func makeBall () {
        ...
        // physics shape matchs ball image
        ball.physicsBody = SKPhysicsBody(circleOfRadius: 10)
        // ignores all forces and impulses
        ball.physicsBody?.isDynamic = false
        // use precise collission detection
    ...
    func makePaddle() {
        paddle.removeFromParent()    // removes the paddle if it exists
    ...
    func makeBrick() {
        brick.removeFromParent()    //remove the brick if it exsits
